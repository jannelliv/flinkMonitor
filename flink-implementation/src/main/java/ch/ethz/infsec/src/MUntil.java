...
public class MUntil implements Mformula<List<Optional<Object>>> {
    ...
    public MUntil(boolean b, Mformula accept, ch.ethz.infsec.policy.Interval interval, Mformula accept1, Tuple tuple, LinkedList<Integer> integers, LinkedList<Triple<Integer, Set<List<Optional<Object>>>, Set<List<Optional<Object>>>>> triples) {
        this.bool = b;
