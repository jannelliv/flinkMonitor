...
public class MSince implements Mformula<List<Optional<Object>>> {
    ...
    public MSince(boolean b, Mformula accept, ch.ethz.infsec.policy.Interval interval, Mformula accept1, LinkedList<Integer> integers, LinkedList<Triple<Integer, HashSet<LinkedList<Optional<Object>>>, HashSet<LinkedList<Optional<Object>>>>> triples) {
        this.bool = b;
